...
func TestGetWithCoords(t *testing.T) {
	...
	t.Run("3D tensor", func(t *testing.T) {
		...
		t3d := ctx.FromFloat32(Shape{2, 3, 4}, data3d)
...
func TestGetWithTensor(t *testing.T) {
	...
	t.Run("2D indices on 2D tensor", func(t *testing.T) {
		...
		indices := ctx.FromInt8([][]int8{{0, 1}, {1, 2}})
		result := source.Get(indices)
	...
	t.Run("single index", func(t *testing.T) {
		...
		source := ctx.FromFloat32(Shape{3, 2}, data)

		indices := ctx.FromInt8([]int8{1})
		result := source.Get(indices)
	...
	t.Run("3D source tensor", func(t *testing.T) {
		...
		source := ctx.FromFloat32(Shape{2, 3, 4}, data3d)
...
func TestGetErrors(t *testing.T) {
	...
	t.Run("no arguments", func(t *testing.T) {
		...
		source := ctx.FromFloat32(Shape{3}, data)
	...
	t.Run("out of bounds tensor index", func(t *testing.T) {
		...
		source := ctx.FromFloat32(Shape{2, 2}, data)

		indices := ctx.FromInt8([]int8{5})
