...
sliceAccumulateKernel(ValueType *dest, size_t destNumDims,
                      ...
                      const ValueType *srcGrad, const dim_t *srcDims,
...
static Result launchSliceAccumulate(const void *dest, size_t destNumDims,
                                    ...
                                    const dim_t *srcDims, size_t srcNumDims,
                                    size_t srcSize) {
...
extern "C" Result runCudaIndexAccumulate1d(Context *ctx, Dtype dtype,
                                           void *dest, const void *indices,
                                           Dtype indexDtype,
                                           const void *srcGrad,
...
extern "C" Result
runCudaIndexAccumulate2d(Context *ctx, Dtype dtype, void *dest, dim_t destDim1,
...
extern "C" Result
runCudaSliceAccumulate(Context *ctx, Dtype dtype, void *dest,
